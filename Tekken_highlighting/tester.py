...
if __name__ == "__main__":
    test_video = "../Videos/testRV/testRV00(42,120).mp4"

    extracted_hv = "../Videos/testRV/testRV00(42,120).npy"
    ...
    np.save("../Videos/testRV/testRV00(42,120)", a)
